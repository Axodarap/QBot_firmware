...
static constexpr int slider_speed = 150;
static constexpr int max_angle = 720;

static constexpr int baudrate = 115200;

//----------------- gripper F -----------------
static constexpr int gripperF_step = 2;
static constexpr int gripperF_dir = 3;
...
//----------------- gripper R -----------------
static constexpr int gripperR_step = 0;
static constexpr int gripperR_dir = 0;
static constexpr int gripperR_en = 0;
...
//----------------- slider x -----------------
static constexpr int sliderX_step = 0;
static constexpr int sliderX_dir = 0;
